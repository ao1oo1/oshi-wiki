...
class WriterPageJumpInsideMainTest extends TestCase
{
    ...
    public function test_writer_layout_places_top_jump_inside_main(): void
    {
    ...
    public function test_writer_layout_places_bottom_jump_inside_main(): void
    {
        $contents = file_get_contents(
            resource_path(
                'views/writer/original_characters/'
    ...
    public function test_writer_page_renders_both_jump_buttons(): void
    {
