@include('writer.original_characters._layout_start', ['title' => 'プロンプト新規登録'])
...
<form method="POST" action="{{ route('writer.prompts.store') }}" class="rounded-3xl border border-[#E2E8F0] bg-white p-6 shadow-sm md:p-8">
