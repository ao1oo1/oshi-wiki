            ...
            <div class="px-5 py-8">
                ...
                <nav class="space-y-3 text-lg font-bold">
                    ...
                    <a href="{{ route('writer.stories.index') }}"
                       class="block rounded-2xl px-5 py-4 {{ request()->routeIs('writer.stories.*') ? 'bg-[#FED7E2] text-[#2D3748]' : 'text-[#2D3748] hover:bg-[#FFF1F5]' }}">
                        ストーリー管理
                    </a>

            <a href="{{ route('writer.story-analyses.index') }}"
               class="block rounded-2xl px-5 py-4 text-xl font-bold transition {{ request()->routeIs('writer.story-analyses.*') ? 'bg-[#FED7E2] text-[#2D3748]' : 'text-[#2D3748] hover:bg-[#FFF1F5]' }}">
                文体分析
            </a>
