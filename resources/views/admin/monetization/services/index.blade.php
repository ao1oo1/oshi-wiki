        ...
        <div class="oshi-card admin-index-shell">
            ...
            <div class="overflow-x-auto rounded-3xl border border-[#E2E8F0] bg-white">
                <table class="w-full min-w-[900px] text-left text-sm">
                    <thead class="bg-[#FFF5F7] text-[#2D3748]"><tr><th class="px-4 py-3">ID</th><th class="px-4 py-3">サービス名</th><th class="px-4 py-3">カテゴリ</th><th class="px-4 py-3">収益方式</th><th class="px-4 py-3">広告形式</th><th class="px-4 py-3">識別子</th><th class="px-4 py-3 text-center">優先順位</th><th class="px-4 py-3 text-center">状態</th><th class="px-4 py-3 text-center">操作</th></tr></thead>
                    <tbody>
                    @forelse ($services as $service)
                        <tr class="border-t border-[#E2E8F0]">
                            ...
                            <td class="px-4 py-4">
                                @if ($service->revenue_model === 'impression')
                                    {{ [
                                        'script' => 'スクリプト',
                                        'text' => 'テキスト',
                                        'image' => '画像',
                    ...
                    @empty
                        <tr><td colspan="9" class="p-8 text-center text-[#718096]">配信・販売サービスは登録されていません。</td></tr>
                    @endforelse
                    </tbody>
                </table>
            </div>
