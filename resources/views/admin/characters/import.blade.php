<x-app-layout>
    ...
    <div class="p-6">
        ...
        <div class="oshi-card">
            ...
            <form method="POST" action="{{ route('admin.characters.import.store') }}">
                @csrf
                ...
                <div class="mb-5">
                    <label for="status" class="mb-1 block font-medium">
                        状態
                    </label>
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        公開ページに出したい場合は「公開」を選択してください。
                    </p>
                </div>

                <div class="mb-5">
                    <label for="raw_text" class="mb-1 block font-medium">
                        キャラクター設定テキスト
                    </label>
                    <textarea
                        id="raw_text"
                        ...
                        rows="18"
                        class="w-full"
                        placeholder="ここにキャラクター設定を貼り付けてください"
