<x-app-layout>
    ...
    <div class="p-6">
        ...
        <div class="oshi-card">
            <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="{{ route('admin.tags.csv-import.sample') }}" class="oshi-btn">CSVサンプルをダウンロード</a>
                    <a href="{{ route('admin.tags.index') }}" class="oshi-btn oshi-btn-sub">タグ一覧へ戻る</a>
                </div>
            </div>

            <form method="POST" action="{{ route('admin.tags.csv-import.store') }}" enctype="multipart/form-data">
                @csrf
        ...
        <div class="oshi-card mt-6">
            ...
            <p>列名：name,type,description,status</p>
        </div>
    </div>
</x-app-layout>
