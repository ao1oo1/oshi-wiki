    ...
    <header class="oshi-header">
        <div class="oshi-container oshi-header-inner">
            ...
            <nav class="oshi-nav">
                ...
                <a href="{{ route('public.about.show') }}" class="{{ request()->routeIs('public.about.*') ? 'active' : '' }}">
                    Oshi-Wikiとは？
                </a>
                <a href="{{ route('public.works.index') }}" class="{{ request()->routeIs('public.works.*') ? 'active' : '' }}">
                    作品一覧
                </a>
                <a href="{{ route('public.tags.index') }}" class="{{ request()->routeIs('public.tags.*') ? 'active' : '' }}">
                    タグ一覧
                </a>
